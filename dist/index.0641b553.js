...
var _saveForm = require("./javascript/saveForm");
...
form.addEventListener('submit', function(event) {
    ...
    (0, _saveForm.formData).addData('name', nameForm.value);
    (0, _saveForm.formData).addData('email', emailForm.value);
    (0, _saveForm.formData).addData('message', messageForm.value);
    (0, _core.success)({
        title: "\u0423\u0441\u043F\u0456\u0448\u043D\u043E!",
        text: "\u0424\u043E\u0440\u043C\u0430 \u0443\u0441\u043F\u0456\u0448\u043D\u043E \u0432\u0456\u0434\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430!",
        delay: 2000
    });
    console.log("\u0414\u0430\u043D\u0456 \u0444\u043E\u0440\u043C\u0438 \u0437\u0431\u0435\u0440\u0435\u0436\u0435\u043D\u043E:", (0, _saveForm.formData).getData());
});

},{"./javascript/saveForm":"gt37M","@pnotify/core":"9RSjy","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/core/dist/BrightTheme.css":"grIyt"}],"gt37M":[function(require,module,exports,__globalThis) {
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}]},["9w8YQ","bNKaB"], "bNKaB", "parcelRequire94c2")
